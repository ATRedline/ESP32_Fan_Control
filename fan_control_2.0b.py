...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.icon.addPixmap(QtGui.QPixmap(fc_path + 'fan_control.ico'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.setWindowTitle("Fan Control 2.0")
...
class SettingsWindow(QWidget):
    ...
    def __init__(self):
        ...
        "Раздел описания элементов третьей вкладки"
        ...
        self.label_7 = QtWidgets.QLabel(self.tab)
        self.label_7.setObjectName("label_7")
        self.label_7.setPixmap(QPixmap(r'esp32.png'))
...
class AppSettings:
    ...
    def __init__(self):
        ...
        self.settings = dict(lang='ru', com='', line_1=True, line_2=False, line_3=False, line_4=False,
                             ...
                             overheat3_en=0, led_ef=0, led_ef_sp=0, led_for_line=1)
        self.cl = '1'
        self.lang_string_ru = ['Мониторинг', 'Настройки', 'Порт:', 'Подкл.', 'Язык:', 'Автозапуск приложения',
                               'Расширенные настройки', 'Вентиляторы', 'Инфо', 'Линия управления:', 'Включена',
        ...
        self.lang_string_en = ['Monitoring', 'Settings', 'Port:', 'Connect', 'Lang:', 'Start with Windows',
                               'Advanced settings', 'FANs', 'About', 'PWM line:', 'Enabled', 'Control for:',
    ...
    def set_lang(self):
        ...
        settings_window.tabWidget.setTabText(settings_window.tabWidget.indexOf(settings_window.tab),
                                             self.lang_string[8])
