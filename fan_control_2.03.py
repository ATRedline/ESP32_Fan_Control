...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Fan Control 2.03")
...
class SettingsWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.gridLayout_7.addItem(spacer13, 7, 0, 1, 1)
        self.gridLayout_7.addWidget(self.line_2, 3, 0, 1, 3)
        self.gridLayout_7.addWidget(self.label_15, 6, 0, 1, 3)
        ...
        self.gridLayout_7.addWidget(self.pushButton_15, 4, 0, 1, 3)
        self.gridLayout_7.addWidget(self.pushButton_17, 1, 2, 1, 1)
...
class AppSettings:
    ...
    def load(self):
        ...
        if 'FanControl' in autoload_values():
            ...
            settings_window.label_18.setEnabled(True)
            settings_window.lineEdit_8.setEnabled(True)
            settings_window.pushButton_17.setEnabled(True)
    ...
    def save_aditional(self):
        ...
        self.settings.update({'boost_zone':boost_zone, 'autoload_delay':auto_load_delay})
...
def autoload_checkbox():
    ...
    if ui.checkBox.isChecked():
        ...
        if 'FanControl' in values_list:
            ...
            settings_window.pushButton_17.setDisabled(True)
...
def change_autoload_delay():
    """Обработка нажатия кнопки смены отсрочки автозапуска"""
    if not settings_window.lineEdit_8.text():
        settings_window.lineEdit_8.setText('1')
    appSettings.settings['autoload_delay'] = int(settings_window.lineEdit_8.text())
    autoload_checkbox()
...
if count < 3:  # Инициализируем программу при отсутствии уже запущенных копий
    ...
    if ab.mon_conf():  # Инициализируем программу если удалось подключиться к MSI:AB
        ...
        settings_window.pushButton_17.clicked.connect(lambda: change_autoload_delay())
